					...
					<div class="box">
						...
						<div class="box-body">
							...
							<div class="form-group  col-xs-12">
								<div class="col-xs-12">
									<textarea value="<?php  echo (!empty($data['job_text']))? $data['job_text'] : ''; ?>" name="job_text" class="editor" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php  echo (!empty($data['job_text']))? $data['job_text'] : ''; ?></textarea>
       ...
       success: function($response){
			...
			{	
				...
				$.each(res,function(i,$item){
					$('#briefTable tbody').append('<tr><td>'+i+'</td><td>'+ $item.briefnum +'</td><td>'+$item.Brief_Date+'</td><td>'+$item.Brief_Status+'</td><td>'+'<button type="button" class="briefSelect btn btn-default" data-brief-no="'+$item.briefnum+'" data-brief-date="'+$item.Brief_Date+'" data-brief-id="'+$item.Brief_ID+'">Select</button>'+'</td></tr>');
