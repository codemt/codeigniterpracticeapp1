							...
							<tbody>
								<?php
								 ...
								 ?>
									<tr>
										<td>	<?php echo ++$i; ?></td>
										<td>	<?php echo $item['jobnumber']; ?></td>
										<td>	<?php echo $item['name']; ?></td>
										<td>	<?php echo $item['brand_name']; ?></td>
										<td>	<?php echo date("d-m-Y",strtotime($item['Brief_Date'])); ?></td>
										<td>	<?php echo $item['job_title']; ?></td>
										<td>	<?php echo date("d-m-Y",strtotime($item['job_date'])); ?></td>
										<td>	<?php echo $item['creator']; ?></td>
										<td>	<?php echo $item['job_status']; ?></td>
										<?php if(in_array('job_payment_info', $permissions)){ ?>
										<td>	<?php echo $item['bill_amount']; ?></td>
										<td>	<?php echo $item['bill_no']; ?></td>
										<td>	<?php echo (!empty($item['bill_date'])) ? date("d-m-Y",strtotime($item['bill_date'])) : ""; ?></td>
										<?php } ?>
								  		<?php if(in_array('job_edit', $permissions)){ ?>
										<td>
											<a href="<?php echo base_url()."job/addEdit/".$item['job_id']; ?>"><i class="fa fa-pencil"></i></a>
